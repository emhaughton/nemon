...
use App\Application\DTOs\ListConsumptionsRequest as UseCaseRequest;
...
use App\Http\Requests\ListConsumptionsRequest;
use Illuminate\Http\JsonResponse;

final class ListConsumptionsController extends Controller
{
    public function __invoke(
        ListConsumptionsRequest $request,
        ListConsumptionsUseCase $useCase,
    ): JsonResponse {
